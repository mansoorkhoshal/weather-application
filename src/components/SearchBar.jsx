...
const SearchBar = () => {
  return (
    <div className="relative w-full max-x-2xl">
      <form className="relative">
        <div className="relative group">
          ...
          <input
            ...
            className="w-full pl-12 pr-24 py-4 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-white/40 transition-all duration-300 hover:bg-white/25"
          />
          {/* Conditional Rendering */}
          <button className="absolute right-14 top-1/2 transform -translate-1/2 text-white/50 hover:text-white transition-all p-1 rounded-full hover:bg-white/10">
            <X className="w-5 h-5" />
          </button>
          {/* <button className="absolute right-4 top-1/2 transform -translate-1/2 text-white/50 hover:text-white transition-all p-1 rounded-full hover:bg-white/10">
      ...
      <div className="absolute top-full left-0 right-0 mt-3 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden z-50">
        ...
        <div className="p-6 text-center text-white/70">
          ...
          <p className="mt-3">Search Cities......</p>
        </div>
        {/* Esle */}
